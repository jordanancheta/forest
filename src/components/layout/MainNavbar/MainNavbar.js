...
const MainNavbar = ({ layout, stickyTop }) => {
  ...
  return (
    <div className={classes}>
      ...
      {/* Changed direction of profile dropdown to justify right, removed Search Bar */}
        <Navbar type="light" className="align-items-stretch flex-md-nowrap p-0 flex-row-reverse">
          {isHeaderNav && (
